                ...
                <table class="table table-bordered table-condensed" style="font-size:12px;" id="mydata">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:middle;">Laporan Penjualan Transaksi By Point</td>
                            <td style="text-align:center;">
                                <a class="btn btn-sm btn-default" href="<?php echo base_url() . 'admin/laporan/laporan_transaksi_point' ?>" target="_blank"><span class="fa fa-print"></span> Print</a>
                            </td>
                        </tr>
        ...
        <div class="modal fade" id="lap_laba_rugi" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/laporan/lap_laba_rugi' ?>">
                        <div class="modal-body">
