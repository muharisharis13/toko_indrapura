...
class M_grafik extends CI_Model
{
    ...
    {
        $query = $this->db->query("SELECT kategori_nama,SUM(barang_stok) AS tot_stok FROM tbl_barang_v2 JOIN tbl_kategori ON barang_kategori_id=kategori_id GROUP BY kategori_nama");
